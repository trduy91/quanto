        ...
        <table class="table">
            ...
            @foreach($surveys as $survey)
                <tr>
                    ...
                    <td>
                    <a class="clipboard" style="cursor: pointer;" data-clipboard-text="http://formstylee.com/client/?id={{ $survey->token }}" title="http://formstylee.com/client/?id={{ $survey->token }}"><i
